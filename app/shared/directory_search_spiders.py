...
class DirectorySearchSpiders:
    ...
    """ データイメージ
    {'asahi_com_sitemap': {'class_instans': <class 'api_crawl.spiders.asahi_com_sitemap.AsahiComSitemapSpider'>,
                        ...
                        'splash_mode': False},
    〜省略〜
    'sankei_com_sitemap': {'class_instans': <class 'api_crawl.spiders.sankei_com_sitemap.SankeiComSitemapSpider'>,
    ...
    def __init__(self, directory_path: str = "api_crawl/spiders") -> None:
                ...
                if ptn.search(class_name) and class_name not in exclusion_list:
                    ...
                    if "allowed_domains" in members:
                        ...
                        if len(members["allowed_domains"]) == 0:
                            ...
                            domain_name = members["allowed_domains"][0].replace(".", "_")
